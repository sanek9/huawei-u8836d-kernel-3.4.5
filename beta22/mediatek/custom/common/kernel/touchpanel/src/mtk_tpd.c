...
#include "tpd.h"
//Add for ESD test.--Jieve Liu
 __attribute__((weak)) void tpd_charger_notify(void)
{
}
...
//#ifdef TPD_TYPE_CAPACITIVE
  ...
  #if defined(TINNO_ANDROID_S8121) || defined(TINNO_ANDROID_S9091) || defined(TINNO_ANDROID_S9096)
