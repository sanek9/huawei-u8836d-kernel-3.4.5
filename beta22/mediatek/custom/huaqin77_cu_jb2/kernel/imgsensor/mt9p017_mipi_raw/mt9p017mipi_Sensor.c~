...
#define SENSORDB(x,...)
#endif
//add by zym 2012-02-27
static kal_uint16 g_isFar = 0;
...
static void MT9P017MIPI_Init_setting(void)
{
	...
	//parallel_interface
				...
				MT9P017MIPI_write_cmos_sensor(0x31AE, 0x0202); // two lane 
				MT9P017MIPI_write_cmos_sensor(0x0112, 0x0218); // 8bit raw output 
		#endif 
	#else 
				do 
				{ 
...
//	MT9P017MIPI_write_cmos_sensor(0x0404, 0x0010);	// SCALE_M
    ...
    //add for af zym 2012-0-23
	MT9P017MIPI_write_cmos_sensor(0x30F0, 0x8000);  //Enable AF function
				MT9P017MIPI_write_cmos_sensor(0x30F2, 0x00F0); //AF step hold 
...
{
	const kal_uint8 i2c_addr[] = {0x6C, 0x6E, MT9P017MIPI_WRITE_ID_1, MT9P017MIPI_WRITE_ID_2}; 
...
UINT32 MT9P017MIPIOpen(void)
{
	...
	g_iMT9P017MIPI_Mode = MT9P017MIPI_MODE_PREVIEW; //This is an increase
 spin_unlock(&MT9P017MIPI_drv_lock);
...
UINT32 MT9P017MIPIClose(void)
{
	...
	mDELAY(20);
         ...
         MT9P017MIPI_write_cmos_sensor(0x30F2, 0x0001);
	mDELAY(20);
    return ERROR_NONE;
}	/* MT9P017MIPIClose() */
...
//	temp = temp & 0xC000 ;
	temp = temp | 0x0041;
	MT9P017MIPI_write_cmos_sensor(0x3040, temp);	//Read Mode = 0x41   001 000001 binning disable
	...
	MT9P017MIPI_write_cmos_sensor(0x300C, 0x14A0);	// Line_LENGTH_LINES
	MT9P017MIPI_write_cmos_sensor(0x300A, 0x07F8);	// Frame_LENGTH_PCK
//	MT9P017MIPI_write_cmos_sensor(0x3012, 0x07F7);	// coarse integration time //2039
//	MT9P017MIPI_write_cmos_sensor(0x3014, 0x12BE);	// fine integration time // 4798
//	MT9P017MIPI_write_cmos_sensor(0x3010, 0x00A0);	// fine correction // 160
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    spin_unlock(&MT9P017MIPI_drv_lock);
	sensor_config_data->SensorImageMirror = IMAGE_HV_MIRROR;//IMAGE_NORMAL; //tangzp_110516
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	else  //5M
	{
	       ...
	       printk("g_iMT9P017MIPI_Mode == MT9P017MIPI_MODE_CAPTURE\n"); 
		    return;
	       }
		   spin_lock(&MT9P017MIPI_drv_lock);
		...
		MT9P017MIPI_Set_Mirror_Flip(IMAGE_HV_MIRROR);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->SensorOutputDataFormat     = SENSOR_OUTPUT_FORMAT_RAW_R;//SENSOR_OUTPUT_FORMAT_RAW_B //tangzp_120522 for color
    ...
    pSensorInfo->AEISPGainDelayFrame = 1;	//2/  //tangzp_120522 for color
    ...
    switch (ScenarioId)
    {
		...
		case MSDK_SCENARIO_ID_CAMERA_ZSD:
            ...
            pSensorInfo->SensorGrabStartY = MT9P017MIPI_FULL_START_Y; 
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
   ...
   printk("***MT9P017MIPIControl ScenarioId = %d\n", ScenarioId);
   switch (ScenarioId)
    {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
...
{    
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_ENG_INFO:
            ...
            pSensorEngInfo->SensorOutputDataFormat= SENSOR_OUTPUT_FORMAT_RAW_R;//SENSOR_OUTPUT_FORMAT_RAW_B //tangzp_120522 for color
